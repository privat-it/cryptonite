...
/** РїРѕСЃР»С–РґРѕРІРЅС–СЃС‚СЊ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ РєР»СЋС‡Р° РїСЂРё Р·Р°С€РёС„СЂРѕРІР°РЅРёРё. */
static const uint8_t ENCRYPT_KEY_ORDER[32] = {
    0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3, 4, 5, 6, 7,
    0, 1, 2, 3, 4, 5, 6, 7, 7, 6, 5, 4, 3, 2, 1, 0
};

/** РїРѕСЃР»С–РґРѕРІРЅС–СЃС‚СЊ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ РєР»СЋС‡Р° РїСЂРё СЂР°СЃС€РёС„СЂРѕРІР°РЅРёРё. */
static const uint8_t DECRYPT_KEY_ORDER[32] = {
    0, 1, 2, 3, 4, 5, 6, 7, 7, 6, 5, 4, 3, 2, 1, 0,
    7, 6, 5, 4, 3, 2, 1, 0, 7, 6, 5, 4, 3, 2, 1, 0
};

/** РїРѕСЃР»С–РґРѕРІРЅС–СЃС‚СЊ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ РєР»СЋС‡Р° РїСЂРё РІС‹СЂР°Р±РѕС‚РєРµ С–Р�?С–С‚РѕРІРµРєС‚РѕСЂР°. */
...
/**
 * Р�РЅРєСЂРµР�?РµРЅС‚РёСЂСѓРµС‚ Р·РЅР°С‡РµРЅРЅСЏ feed.
 *
 * @param feed СѓРєР°Р·Р°С‚РµР»СЊ РЅР° 32-Р±Р°Р№С‚РЅС‹Р№ feed
 */
...
/*Р�СЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РІ Р”РЎРўРЈ4145 Рё Р“РћРЎРў28147.*/
int  gost28147_ecb_core(Gost28147Ctx *ctx, const uint8_t *src, size_t len, bool is_encrypt, uint8_t *dst)
{
    ...
    /* РЁРёС„СЂСѓРµР�? С„СЂР°РіР�?РµРЅС‚Р°Р�?Рё РїРѕ 24 Р±Р°Р№С‚Р°. */
    for (i = len / 24; i > 0; i--) {
    ...
    /* РЁРёС„СЂСѓРµР�? РѕСЃС‚Р°РІС€РёРµСЃСЏ 8 Р°Р±Рѕ 16 Р±Р°Р№С‚. */
...
static int gost28147_ctr_crypt(Gost28147Ctx *ctx, const uint8_t *src, uint8_t *dst, size_t len)
{
    ...
    /* Р•СЃР»Рё РѕСЃС‚Р°Р»Р°СЃСЊ РЅРµ РёСЃРїРѕР»СЊР·РѕРІР°РЅРЅР°СЏ С‡Р°СЃС‚СЊ РіР°Р�?Р�?С‹. */
    if (ctx_off != 0) {
    ...
    if (data_off < len) {
        /* РЁРёС„СЂРѕРІР°РЅРёРµ Р±Р»РѕРєР°Р�?Рё РїРѕ 24 Р±Р°Р№С‚Р°. */
...
static int gost28147_cfb_core(Gost28147Ctx *ctx, const uint8_t *src, size_t len, bool is_encrypt, uint8_t *dst)
{
    ...
    if (is_encrypt) {
        ...
        if (data_off < len) {
            /* Р Р°СЃС€РёС„СЂРѕРІР°РЅРёРµ Р±Р»РѕРєР°Р�?Рё РїРѕ 8 Р±Р°Р№С‚. */
            for (; data_off + 8 <= len; data_off += 8) {
