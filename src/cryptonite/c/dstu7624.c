...
/*РўР°Р±Р»РёС†Р° РґР»СЏ РѕРїРµСЂР°С†РёРё sbox*/
...
/*РўР°Р±Р»РёС†Р° РґР»СЏ РѕРїРµСЂР°С†РёРё sbox_inv*/
...
static int precomputed_rkeys(Dstu7624Ctx *ctx, uint64_t *precompute_keyshifts, uint64_t *p_hrkey)
{
    ...
    /*Р’С‹С‡РёСЃР»СЏРµР�? С‡РµС‚РЅС‹Рµ СЂР°СѓРЅРґРѕРІС‹Рµ РєР»СЋС‡Рё.*/
    ...
    /*Р’С‹С‡РёСЃР»СЏРµР�? РЅРµС‡РµС‚РЅС‹Рµ СЂР°СѓРЅРґРѕРІС‹Рµ РєР»СЋС‡Рё РїСѓС‚РµР�? СЃР�?РµС‰РµРЅРёСЏ С‡РµС‚РЅС‹С…*/
...
/*Р¤СѓРЅРєС†РёСЏ РґР»СЏ РѕР±С‡РёСЃР»РµРЅРЅСЏ СЃРґРІРёРіР° СЃРµРєСЂРµС‚РЅРѕРіРѕ РєР»СЋС‡Р°.*/
static int p_key_shift(const uint8_t *key, Dstu7624Ctx *ctx, uint64_t **key_shifts)
{
    ...
    /*Р’С‹Р±РёСЂР°РµР�? СЂРµР¶РёР�? РіРµРЅРµСЂРёСЂРѕРІР°РЅРёРµ РІСЃРїРѕР�?РѕРіР°С‚РµР»СЊРЅС‹С… СЂР°СѓРЅРґРѕРІС‹С… РєР»СЋС‡РµР№.*/
    if (block_len == key_len) {
        for (i = 0; i <= ctx->rounds >> 1; ++i) {
            for (j = 0; j < key_len; ++j) {
                /*Р’С‹С‡РёСЃР»СЏРµР�? СЂР°Р·Р�?РµСЂ СЃРґРІРёРіР°*/
                shift = 56 * i;
                /*РЎРѕР·РґР°РµР�? РЅРѕРІС‹Р№ Р�?Р°СЃСЃРёРІ c РЅРµРѕР±С…РѕРґРёР�?С‹Р�? СЃРґРІРёРіРѕР�?.*/
...
static int dstu7624_init(Dstu7624Ctx *ctx, const ByteArray *key, const size_t block_size)
{
    ...
    /*Р†РЅС–С†С–Р°Р»С–Р·Р°С†С–СЏ РЅР°С‡Р°Р»СЊРЅС‹С… РґР°РЅРёС… Р”РЎРўРЈ7624 Сѓ СЃРѕРѕС‚РІРµС‚СЃРІРёРё Р· СЂРѕР·Р�?С–СЂРѕР�? Р±Р»РѕРєР° С– РєР»СЋС‡Р°.*/
    if (key_buf_len == KALINA_128_KEY_LEN && block_size == KALINA_128_BLOCK_LEN) {
        p_hrkey[0] = 0x05; // РґР°РЅС– РґР»СЏ РёРЅРёС†РёР°Р»РёР·Р°С†РёРё СЂР°СѓРЅРґРѕРІРѕРіРѕ РєР»СЋС‡Р°.
        ctx->subrowcol = subrowcol128; // РћРїРµСЂР°С†РёСЏ Р±С‹СЃС‚СЂРѕРіРѕ РѕР±С‡РёСЃР»РµРЅРЅСЏ sbox, srow, mcol.
        ctx->basic_transform =
                basic_transform_128; // РћРїРµСЂР°С†РёСЏ Р±Р°Р·РѕРІРѕРіРѕ РїСЂРµРѕР±СЂР°Р·РѕРІР°РЅРёСЏ РґР»СЏ РґР°РЅРЅРѕРіРѕ СЂРµР¶РёР�?Сѓ.
        ctx->subrowcol_dec =
                subrowcol128_dec; // РћРїРµСЂР°С†РёСЏ РѕР±СЂР°С‚РЅРѕРіРѕ Р±Р°Р·РѕРІРѕРіРѕ РїСЂРµРѕР±СЂР°Р·РѕРІР°РЅРёСЏ.
        ctx->rounds =
                10; // РєС–Р»СЊРєС–СЃС‚СЊ СЂР°СѓРЅРґРѕРІ РґР»СЏ РіРµРЅРµСЂРёСЂРѕРІР°РЅРёСЏ СЂР°СѓРЅРґРѕРІРѕРіРѕ РєР»СЋС‡Р°.
        ...
        uint8_t **h_out, size_t Nb)
{
    ...
    /*РќР°С‡Р°Р»Рѕ РІРёСЂРѕР±РєРё С–Р�?С–С‚РѕРІСЃС‚Р°РІРєРё*/
    ...
    //РЎРѕР·РґР°РЅРёРµ Р·Р°РіРѕР»РѕРІРєР° Р°СѓС‚РµРЅС‚РёС„РёРєР°С†РёРё
    ...
    //РљРѕРґ РґРѕРІР¶РёРЅРё С–Р�?С–С‚РѕРІСЃС‚Р°РІРєРё. РћРїСЂРµРґРµР»РµРЅ Сѓ СЃС‚Р°РЅРґР°СЂС‚Рµ.
    ...
    G1[block_len - 1] |= ((Nb - 1));
    //РљРѕРЅРµС† СЃРѕР·РґР°РЅРёСЏ Р·Р°РіРѕР»РѕРІРєР° Р°СѓС‚РµРЅС‚РёС„РёРєР°С†РёРё
    ...
    *h_out = h;
    ...
    /*РљРѕРЅРµС† РІРёСЂРѕР±РєРё С–Р�?С–С‚РѕРІСЃС‚Р°РІРєРё*/
...
static int encrypt_ctr(Dstu7624Ctx *ctx, const ByteArray *src, ByteArray **dst)
{
    ...
    if (data_off < src->len) {
        /* РЁРёС„СЂСѓРІР°РЅРЅСЏ Р±Р»РѕРєР°Р�?Рё РїРѕ 8 Р±Р°Р№С‚. */
        ...
        /* РЁРёС„СЂСѓРІР°РЅРЅСЏ РїРѕСЃР»РµРґРЅР№РѕРіРѕ РЅРµРїРѕР»РЅРѕРіРѕ Р±Р»РѕРєР°. */
...
static int encrypt_xts(Dstu7624Ctx *ctx, const ByteArray *in, ByteArray **out)
{
    ...
    if (padded_len != block_len) {
        //Р”РѕРїРѕР»РЅСЏРµР�? РїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРє С€РёС„СЂРѕС‚РµРєСЃС‚РѕР�? РїСЂРµРґРїРѕСЃР»РµРґРЅРµРіРѕ
        i += plain_size % block_len;
        memcpy(&plain_data[i], &plain_data[i - block_len], padded_len);
        i -= plain_size % block_len;

        //РљРѕРЅРІРµСЂС‚РёСЂСѓРµР�? Р° РґР»СЏ Р±Рµ Р�?Р°С€РёРЅ.
        DO(gf2m_mul(ctx->mode.xts.gf2m_ctx, block_len, gamma, two, gamma));
        kalina_xor(&plain_data[i], gamma, block_len, &plain_data[i]);
        crypt_basic_transform(ctx, &plain_data[i], &plain_data[i]);
        kalina_xor(&plain_data[i], gamma, block_len, &plain_data[i]);
        //РњРµРЅСЏРµР�? n-1 Р±Р»РѕРє Рё nР№ Р�?РµСЃС‚Р°Р�?Рё.
...
static int decrypt_xts(Dstu7624Ctx *ctx, const ByteArray *in, ByteArray **out)
{
    ...
    if (padded_len != block_len) {
        //Р•СЃР»Рё Р±С‹Р»Рѕ РґРѕРїРѕР»РЅРµРЅРёРµ, РЅР° РІС…РѕРґ РїСЂРёС…РѕРґСЏС‚ РїРѕСЃР»РµРґРЅРёР№ Рё РїСЂРµРґРїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРє
        //РўР°Рє РєР°Рє РїСЂРё РґРѕРїРѕР»РЅРµРЅРёРё РІ С€РёС„СЂРѕРІР°РЅРёРё Р�?РµРЅСЏСЋС‚СЃСЏ Р�?РµСЃС‚Р°Р�?Рё РїРѕСЃР»РµРґРЅРёР№ Рё РїСЂРµРґРїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРєРё, СЂР°СЃС€РёС„СЂРѕРІСѓРµР�? РїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРє, РєР°Рє РїСЂРµРґРїРѕСЃР»РµРґРЅРёР№
        DO(gf2m_mul(ctx->mode.xts.gf2m_ctx, block_len, gamma, two, gamma));
        ...
        //Р’ РєРѕРЅС†Рµ РїСЂРµРґРїРѕСЃР»РµРґРЅРµРіРѕ Р±Р»РѕРєР° С…СЂР°РЅРёС‚СЃСЏ РґРѕРїРѕР»РЅРµРЅРёРµ Рє РїРѕСЃР»РµРґРЅРµР�?Сѓ Р±Р»РѕРєСѓ
        i += block_len;
        i += plain_size % block_len;
        //Р—Р°РїРёСЃС‹РІР°РµР�? РїРѕР»СѓС‡РµРЅРѕРµ РґРѕРїРѕР»РЅРµРЅРёРµ Рё СЂР°СЃС€РёС„СЂРѕРІСѓРµР�?
        memcpy(&plain_data[i], &plain_data[i - block_len], padded_len);
        i -= plain_size % block_len;
...
static int encrypt_cfb(Dstu7624Ctx *ctx, const ByteArray *in, ByteArray **dst)
{
    ...
    if (data_off < in->len) {
        /* РЁРёС„СЂСѓРІР°РЅРЅСЏ Р±Р»РѕРєР°Р�?Рё РїРѕ ctx->block_len Р±Р°Р№С‚. */
        ...
        ByteArray **h, ByteArray **cipher_text)
{
    ...
    /*РЁРёС„СЂСѓРІР°РЅРЅСЏ С– РѕР±РµСЃРїРµС‡РµРЅРёРµ С†РµР»РѕСЃС‚РЅРѕСЃС‚Рё.*/
    ...
    /*Р’С‹СЂР°Р±РѕС‚РєР° С–Р�?С–С‚РѕРІСЃС‚Р°РІРєРё.*/
    padding(ctx, plain_buf, &plain_len, plain_buf);
    ctx->basic_transform(ctx, H);
    /*H - Сѓ Р»Рµ С„РѕСЂР�?Р°С‚Рµ. Р”Р»СЏ СѓР�?РЅРѕР¶РµРЅРёСЏ РЅР°Р�? РЅСѓР¶РЅРѕ 2 Р±Рµ С„РѕСЂР�?Р°С‚Р°. auth_buf - Р±Рµ.*/
...
static int gmac_update(Dstu7624Ctx *ctx, const ByteArray *plain_data)
{
    ...
    //РџСЂРёРІРѕРґРёР�? РґР°РЅРЅС‹Рµ Рє u8 С‚РёРїСѓ
    ...
    //Р•СЃР»Рё РїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРє РЅРµ РїСѓСЃС‚РѕР№:
    if (last_block_len != 0) {
        /*Р•СЃР»Рё РґР»РёРЅРЅР° РїРѕСЃР»РµРґРЅРµРіРѕ Р±Р»РѕРєР° Рё РґР°РЅРЅС‹С… РІ СЃСѓР�?Р�?Рµ Р�?РµРЅСЊС€Рµ СЂР°Р·Р�?РµСЂР° Р±Р»РѕРєР°*/
        if (last_block_len + data_len < block_len) {
            //Р”РѕР±Р°РІР»СЏРµР�? РІ РєРѕРЅРµС† РїРѕСЃР»РµРґРЅРµРіРѕ Р±Р»РѕРєР° РЅРѕРІС‹Рµ РґР°РЅРЅС‹Рµ
            memcpy(&last_block[last_block_len], data_buf, data_len);
            ctx->mode.gmac.last_block_len += data_len;
            goto cleanup;
        } else {
            //РљСЃРѕСЂРёР�? РїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРє СЃ С‚РµРєСѓС‰РёР�?Рё РґР°РЅРЅС‹Р�?Рё
            kalina_xor(last_block, B8, last_block_len, B8);
            tail_len = block_len - last_block_len;
            //РљСЃРѕСЂРёР�? РїРµСЂРІС‹Рµ Р±Р°Р№С‚С‹ РёР· РїСЂРёС€РµРґС€РµРіРѕ Р±Р»РѕРєР°, РґРѕ СЂР°Р·Р�?РµСЂР° Р±Р»РѕРєР°.
    ...
    //Р’С‹СЃС‡РёС‚С‹РІР°РµР�? РѕСЃС‚Р°С‚РѕРє
...
static int gmac_final(Dstu7624Ctx *ctx, ByteArray **mac)
{
    ...
    // РџСЂРѕРІРµСЂСЏРµР�?, РЅСѓР¶РЅРѕ Р»Рё РґРѕСЃС‚С‡РёС‚С‹РІР°С‚СЊ РїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРє.
    if (last_block_len != 0) {
        //Р•СЃР»Рё РїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРє РЅРµ РЅСѓР»РµРІРѕР№, РґРѕРїРѕР»РЅСЏРµР�? РµРіРѕ.
    ...
    //Р—Р°РїРёСЃС‹РІР°РµР�? РґР»РёРЅРЅСѓ РІСЃРµРіРѕ СЃРѕРѕР±С‰РµРЅРёСЏ РІ Р±РёС‚Р°С…
...
static int encrypt_ofb(Dstu7624Ctx *ctx, const ByteArray *in, ByteArray **out)
{
    ...
    if (used_gamma_len != 0) {
        //Р•СЃР»Рё СЂР°Р·Р�?РµСЂ РїСЂРёС€РµРґС€РёС… РґР°РЅРЅС‹С… Р�?РµРЅСЊС€Рµ С‡РµР�? РѕСЃС‚Р°РІС€РµРіРѕСЃСЏ С…РµС€Р°, С‚Рѕ С€РёС„СЂСѓРµР�? С‚РѕР»СЊРєРѕ РїСЂРёС€РµРґС€РёС… РґР°РЅРЅС‹Рµ.
...
static int cmac_update(Dstu7624Ctx *ctx, const ByteArray *in)
{
    ...
    //Р•СЃР»Рё РґР»РёРЅРЅР° Р±Р»РѕРєР° Рё РІС…РѕРґРЅС‹С… РґР°РЅРЅС‹С… Р�?РµРЅСЊС€Рµ СЂР°Р·Р�?РµСЂР° Р±Р»РѕРєР°, С‚Рѕ Р·Р°РїРёСЃС‹РІР°РµР�? РґР°РЅРЅС‹Рµ РІ РїРѕСЃР»РµРґРЅРёР№ Р±Р»РѕРє Рё РІС‹С…РѕРґРёР�?.
    ...
    //Р�С‰РµР�? РїСЂРµРѕР±СЂР°Р·РѕРІР°РЅРёРµ РѕС‚ РїРѕСЃР»РµРґРЅРµРіРѕ Р±Р»РѕРєР° Рё РѕСЃС‚Р°Р»СЊРЅС‹С… РґР°РЅРЅС‹С…
