 ...
 */
CRYPTONITE_EXPORT asn_dec_rval_t xer_decode(struct asn_codec_ctx_s *opt_codec_ctx,
 ...
 */
CRYPTONITE_EXPORT asn_dec_rval_t xer_decode_general(asn_codec_ctx_t *opt_codec_ctx,
...
CRYPTONITE_EXPORT ssize_t   xer_next_token(int *stateContext,
 ...
 */
CRYPTONITE_EXPORT size_t xer_whitespace_span(const void *chunk_buf, size_t chunk_size);

/*
 * Skip the series of anticipated extensions.
 */
CRYPTONITE_EXPORT int xer_skip_unknown(xer_check_tag_e tcv, ber_tlv_len_t *depth);
