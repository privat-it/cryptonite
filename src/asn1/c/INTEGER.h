...
CRYPTONITE_EXPORT asn_TYPE_descriptor_t *get_INTEGER_desc(void);
 ...
 */
CRYPTONITE_EXPORT int asn_INTEGER2long(const INTEGER_t *i, long *l);
CRYPTONITE_EXPORT int asn_INTEGER2ulong(const INTEGER_t *i, unsigned long *l);
CRYPTONITE_EXPORT int asn_long2INTEGER(INTEGER_t *i, long l);
CRYPTONITE_EXPORT int asn_ulong2INTEGER(INTEGER_t *i, unsigned long l);
