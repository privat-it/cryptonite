...
#undef FILE_MARKER
#define FILE_MARKER "asn1/REAL.c"
...
asn_TYPE_descriptor_t REAL_desc = {
    "REAL",
    "REAL",
...
asn_TYPE_descriptor_t *get_REAL_desc(void)
{
    return &REAL_desc;
}
...
#ifdef _MSC_VER
    UNREFERENCED_PARAMETER(assertion_buffer1);
    UNREFERENCED_PARAMETER(assertion_buffer2);
#endif
