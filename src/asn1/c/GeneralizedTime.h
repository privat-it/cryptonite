...
CRYPTONITE_EXPORT asn_TYPE_descriptor_t *get_GeneralizedTime_desc(void);
 ...
 */
CRYPTONITE_EXPORT time_t  asn_GT2time(const GeneralizedTime_t *, struct tm *_optional_tm4fill,
        int as_gmt);

/* A version of the above function also returning the fractions of seconds */
CRYPTONITE_EXPORT time_t  asn_GT2time_frac(const GeneralizedTime_t *,
 ...
 */
CRYPTONITE_EXPORT time_t  asn_GT2time_prec(const GeneralizedTime_t *,
 ...
 */
CRYPTONITE_EXPORT GeneralizedTime_t  *asn_time2GT(GeneralizedTime_t *_optional_gt,
        const struct tm *, int force_gmt);
CRYPTONITE_EXPORT GeneralizedTime_t  *asn_time2GT_frac(GeneralizedTime_t *_optional_gt,
