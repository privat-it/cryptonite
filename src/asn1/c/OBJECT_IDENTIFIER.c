...
asn_TYPE_descriptor_t OBJECT_IDENTIFIER_desc = {
    "OBJECT IDENTIFIER",
    "OBJECT_IDENTIFIER",
...
asn_TYPE_descriptor_t *get_OBJECT_IDENTIFIER_desc(void)
{
    return &OBJECT_IDENTIFIER_desc;
}
...
int
OBJECT_IDENTIFIER_get_single_arc(const uint8_t *arcbuf, unsigned int arclen, signed int add, void *rvbufp,
        unsigned int rvsize)
{
...
OBJECT_IDENTIFIER__xer_body_decode(asn_TYPE_descriptor_t *td, void *sptr, const void *chunk_buf, size_t chunk_size) {
    ...
    ASSERT(endptr ==  (const char *)chunk_buf + chunk_size);
...
int
OBJECT_IDENTIFIER_set_arcs(OBJECT_IDENTIFIER_t *oid, const void *arcs, unsigned int arc_type_size,
