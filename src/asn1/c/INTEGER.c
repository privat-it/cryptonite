...
asn_TYPE_descriptor_t INTEGER_desc = {
    "INTEGER",
    "INTEGER",
...
asn_TYPE_descriptor_t *get_INTEGER_desc(void)
{
    return &INTEGER_desc;
}
...
static const asn_INTEGER_enum_map_t *INTEGER_map_enum2value(asn_INTEGER_specifics_t *specs, const char *lstart,
        const char *lstop);
 ...
 */
static ssize_t
INTEGER__dump(const asn_TYPE_descriptor_t *td, const INTEGER_t *st, asn_app_consume_bytes_f *cb, void *app_key,
        int plainOrXER)
{
