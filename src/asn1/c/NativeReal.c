...
#undef FILE_MARKER
#define FILE_MARKER "asn1/NativeReal.c"
...
asn_TYPE_descriptor_t NativeReal_desc = {
...
asn_TYPE_descriptor_t *get_NativeReal_desc(void)
{
    return &NativeReal_desc;
}
        ...
        asn_app_consume_bytes_f *cb, void *app_key)
{
    ...
    ASN_FREE_CONTENT_STATIC(&REAL_desc, &tmp);
