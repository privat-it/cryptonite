...
#define    ASN_STRUCT_FREE_CONTENTS_ONLY(asn_DEF, ptr) { if (ptr != NULL) {(asn_DEF)->free_struct(asn_DEF,ptr,1); memset(ptr, 0, sizeof *ptr);}}
#define    ASN_STRUCT_FREE_CONTENTS_ONLY_VOID(asn_DEF, ptr) (asn_DEF)->free_struct(asn_DEF,ptr,1)
 ...
 */
CRYPTONITE_EXPORT int asn_fprint(FILE *stream,        /* Destination stream descriptor */
