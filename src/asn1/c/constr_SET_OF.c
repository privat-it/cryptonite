...
microphase2:
            ...
            case RC_FAIL: /* Fatal error */
                elm->type->free_struct(elm->type, ctx->ptr, 0);
                ctx->ptr = 0;
                RETURN(RC_FAIL);
            } /* switch(rval) */
...
/*
 * The BER encoder of the SET OF type.
 */
asn_enc_rval_t
SET_OF_encode_ber(asn_TYPE_descriptor_t *td, void *ptr,
        ...
        asn_app_consume_bytes_f *cb, void *app_key)
{
    ...
    /*
     * BER not sort attributes!!!
     * Disable sort the encoded elements according to their encoding.
        ...
        asn_per_constraints_t *constraints, void **sptr, asn_per_data_t *pd)
{
    ...
    do {
        ...
        for (i = 0; i < nelems; i++) {
            ...
            if (ptr) {
                elm->type->free_struct(elm->type, ptr, 0);
            }
            return rv;
        }
