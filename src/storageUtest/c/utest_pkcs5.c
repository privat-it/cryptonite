...
static void test_pkcs5_get_type(void)
{
    ByteArray *encrypted_key =
            ba_alloc_from_le_hex_string("");
...
static void test_pkcs5_decrypt_dstu_unsup_enc_scheme_alg(void)
{
    ...
    ASSERT_RET_OK(asn_set_oid(oids_get_oid_numbers_by_id(OID_KDF_ID)->numbers,
            oids_get_oid_numbers_by_id(OID_KDF_ID)->numbers_len,
    ...
    ASN_ALLOC(encr_key);
    ASSERT_RET_OK(asn_set_oid(oids_get_oid_numbers_by_id(OID_PBES2_ID)->numbers,
            oids_get_oid_numbers_by_id(OID_PBES2_ID)->numbers_len,
...
static void test_pkcs5_decrypt_dstu_unsup_kdf_params_alg(void)
{
    ...
    ASN_ALLOC(params);
    ASSERT_RET_OK(asn_copy(&PBES2_KDFs_desc, kdf_params, &params->keyDerivationFunc));
    ASSERT_RET_OK(asn_set_oid(oids_get_oid_numbers_by_id(OID_GOST28147_DSTU_ID)->numbers,
            oids_get_oid_numbers_by_id(OID_GOST28147_DSTU_ID)->numbers_len,
