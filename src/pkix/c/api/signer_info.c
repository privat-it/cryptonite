        ...
        const VerifyAdapter *va)
{
    ...
    /*
     * РџСЂРѕРІРµСЂРєР°: РїРѕ СЂРµР·СѓР»СЊС‚Р°С‚Р°Р�? РїСЂРѕРІРµСЂРєРё С†РёС„СЂРѕРІРѕР№ РїРѕРґРїРёСЃРё СѓСЃС‚Р°РЅРѕРІР»РµРЅРѕ, С‡С‚Рѕ
     * С†РёС„СЂРѕРІР°СЏ РїРѕРґРїРёСЃСЊ РІРµСЂРЅР°;
     */
    /* IIT РЅРµ СЃРѕСЂС‚РёСЂСѓРµС‚ Р°С‚СЂРёР±СѓС‚С‹, РїРѕС‚РѕР�?Сѓ РёС… СЃРѕСЂС‚РёСЂРѕРІРєР° РѕС‚РєР»СЋС‡РµРЅР°, Рё РїСЂРё РіРµРЅРµСЂР°С†РёРё РІС‹РїРѕР»РЅСЏРµС‚СЃСЏ РїСЂРёРЅСѓРґРёС‚РµР»СЊРЅРѕ !!! */
...
int sinfo_get_message_digest(const SignerInfo_t *sinfo, ByteArray **hash)
{
    ...
    /*
     * РџСЂРѕРІРµСЂРєР°: С…СЌС€-Р·РЅР°С‡РµРЅРёРµ РґР°РЅРЅС‹С… (РёРЅРєР°РїСЃСѓР»РёСЂРѕРІР°РЅРЅС‹С… РёР»Рё РІРЅРµС€РЅРёС…)
     * РѕС‚РІРµС‡Р°РµС‚ Р·РЅР°С‡РµРЅРёСЋ, РїСЂРёРІРµРґРµРЅРЅРѕР�?Сѓ РІ Р°С‚СЂРёР±СѓС‚Рµ вЂњmessage-digestвЂќ.
     */
        ...
        const ByteArray *data)
{
     ...
     * С†РёС„СЂРѕРІР°СЏ РїРѕРґРїРёСЃСЊ РІРµСЂРЅР°;
     */
    /* IIT РЅРµ СЃРѕСЂС‚РёСЂСѓРµС‚ Р°С‚СЂРёР±СѓС‚С‹ !!! */
    DO(asn_encode_ba(&Attributes_desc, sinfo->signedAttrs, &signed_attrs));
    DO(sign_os_to_ba(&sinfo->signature, &sinfo->signatureAlgorithm, &sign));
    DO(va->verify_data(va, signed_attrs, sign));
    LOG_ENTRY();
...
/**
 * РџСЂРѕРІРµСЂСЏРµС‚ РЅР°Р»РёС‡РёРµ РЅРµРїРѕРґРїРёСЃС‹РІР°РµР�?РѕРіРѕ Р°С‚СЂРёР±СѓС‚Р° РїРѕ OID`Сѓ.
 *
 * @param sinfo РёРЅС„РѕСЂР�?Р°С†РёСЏ Рѕ РїРѕРґРїРёСЃС‡РёРєРµ
 * @param oid_longs РёРґРµРЅС‚РёС„РёРєР°С‚РѕСЂ
 *
...
/**
 * РџСЂРѕРІРµСЂСЏРµС‚ РЅР°Р»РёС‡РёРµ РїРѕРґРїРёСЃС‹РІР°РµР�?РѕРіРѕ Р°С‚СЂРёР±СѓС‚Р° РїРѕ OID`Сѓ.
 *
 * @param sinfo РёРЅС„РѕСЂР�?Р°С†РёСЏ Рѕ РїРѕРґРїРёСЃС‡РёРєРµ
 * @param oid_arr РёРґРµРЅС‚РёС„РёРєР°С‚РѕСЂ
 *
 * @return РєРѕРґ РѕС€РёР±РєРё
 */
