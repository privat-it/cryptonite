...
static const ber_tlv_tag_t AttributeTypeAndValue_desc_tags_1[] = {
...
asn_TYPE_descriptor_t AttributeTypeAndValue_desc = {
    ...
    AttributeTypeAndValue_desc_tags_1,
    sizeof(AttributeTypeAndValue_desc_tags_1)
    / sizeof(AttributeTypeAndValue_desc_tags_1[0]), /* 1 */
    AttributeTypeAndValue_desc_tags_1,    /* Same as above */
    sizeof(AttributeTypeAndValue_desc_tags_1)
    / sizeof(AttributeTypeAndValue_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_AttributeTypeAndValue_desc(void)
{
