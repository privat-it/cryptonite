...
static const ber_tlv_tag_t TerminalIdentifier_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (19 << 2))
};
asn_TYPE_descriptor_t TerminalIdentifier_desc = {
    "TerminalIdentifier",
    "TerminalIdentifier",
    ...
    TerminalIdentifier_desc_tags_1,
    sizeof(TerminalIdentifier_desc_tags_1)
    / sizeof(TerminalIdentifier_desc_tags_1[0]), /* 1 */
    TerminalIdentifier_desc_tags_1,    /* Same as above */
    sizeof(TerminalIdentifier_desc_tags_1)
    / sizeof(TerminalIdentifier_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_TerminalIdentifier_desc(void)
{
