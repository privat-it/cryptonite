...
#undef FILE_MARKER
#define FILE_MARKER "pkix/struct/AttCertVersionV1.c"
...
static const ber_tlv_tag_t AttCertVersionV1_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (2 << 2))
};
asn_TYPE_descriptor_t AttCertVersionV1_desc = {
    "AttCertVersionV1",
    "AttCertVersionV1",
    ...
    AttCertVersionV1_desc_tags_1,
    sizeof(AttCertVersionV1_desc_tags_1)
    / sizeof(AttCertVersionV1_desc_tags_1[0]), /* 1 */
    AttCertVersionV1_desc_tags_1,    /* Same as above */
    sizeof(AttCertVersionV1_desc_tags_1)
    / sizeof(AttCertVersionV1_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_AttCertVersionV1_desc(void)
{
    return &AttCertVersionV1_desc;
}
