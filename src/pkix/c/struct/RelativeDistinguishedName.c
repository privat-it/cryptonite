...
static const ber_tlv_tag_t RelativeDistinguishedName_desc_tags_1[] = {
...
asn_TYPE_descriptor_t RelativeDistinguishedName_desc = {
    ...
    RelativeDistinguishedName_desc_tags_1,
    sizeof(RelativeDistinguishedName_desc_tags_1)
    / sizeof(RelativeDistinguishedName_desc_tags_1[0]), /* 1 */
    RelativeDistinguishedName_desc_tags_1,    /* Same as above */
    sizeof(RelativeDistinguishedName_desc_tags_1)
    / sizeof(RelativeDistinguishedName_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_RelativeDistinguishedName_desc(void)
{
