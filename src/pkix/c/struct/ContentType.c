...
#undef FILE_MARKER
#define FILE_MARKER "pkix/struct/ContentType.c"
...
static const ber_tlv_tag_t ContentType_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (6 << 2))
};
asn_TYPE_descriptor_t ContentType_desc = {
    "ContentType",
    "ContentType",
    ContentType_free,
    ContentType_print,
    ...
    ContentType_desc_tags_1,
    sizeof(ContentType_desc_tags_1)
    / sizeof(ContentType_desc_tags_1[0]), /* 1 */
    ContentType_desc_tags_1,    /* Same as above */
    sizeof(ContentType_desc_tags_1)
    / sizeof(ContentType_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_ContentType_desc(void)
{
