...
static const ber_tlv_tag_t X121Address_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (18 << 2))
};
asn_TYPE_descriptor_t X121Address_desc = {
    "X121Address",
    "X121Address",
    X121Address_free,
    X121Address_print,
    ...
    X121Address_desc_tags_1,
    sizeof(X121Address_desc_tags_1)
    / sizeof(X121Address_desc_tags_1[0]), /* 1 */
    X121Address_desc_tags_1,    /* Same as above */
    sizeof(X121Address_desc_tags_1)
    / sizeof(X121Address_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_X121Address_desc(void)
{
