...
static const ber_tlv_tag_t Hash_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (4 << 2))
};
asn_TYPE_descriptor_t Hash_desc = {
    "Hash",
    "Hash",
    Hash_free,
    Hash_print,
    ...
    Hash_desc_tags_1,
    sizeof(Hash_desc_tags_1)
    / sizeof(Hash_desc_tags_1[0]), /* 1 */
    Hash_desc_tags_1,    /* Same as above */
    sizeof(Hash_desc_tags_1)
    / sizeof(Hash_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_Hash_desc(void)
{
    return &Hash_desc;
}
