...
#undef FILE_MARKER
#define FILE_MARKER "pkix/struct/Version.c"
...
static const ber_tlv_tag_t Version_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (2 << 2))
};
asn_TYPE_descriptor_t Version_desc = {
    "Version",
    "Version",
    Version_free,
    Version_print,
    ...
    Version_desc_tags_1,
    sizeof(Version_desc_tags_1)
    / sizeof(Version_desc_tags_1[0]), /* 1 */
    Version_desc_tags_1,    /* Same as above */
    sizeof(Version_desc_tags_1)
    / sizeof(Version_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_Version_desc(void)
{
    return &Version_desc;
}
