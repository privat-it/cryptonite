...
#undef FILE_MARKER
#define FILE_MARKER "pkix/struct/UniqueIdentifier.c"
...
static const ber_tlv_tag_t UniqueIdentifier_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (3 << 2))
};
asn_TYPE_descriptor_t UniqueIdentifier_desc = {
    "UniqueIdentifier",
    "UniqueIdentifier",
    ...
    UniqueIdentifier_desc_tags_1,
    sizeof(UniqueIdentifier_desc_tags_1)
    / sizeof(UniqueIdentifier_desc_tags_1[0]), /* 1 */
    UniqueIdentifier_desc_tags_1,    /* Same as above */
    sizeof(UniqueIdentifier_desc_tags_1)
    / sizeof(UniqueIdentifier_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_UniqueIdentifier_desc(void)
{
    return &UniqueIdentifier_desc;
}
