...
static const ber_tlv_tag_t SubjectAltName_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_TYPE_descriptor_t SubjectAltName_desc = {
    "SubjectAltName",
    "SubjectAltName",
    SubjectAltName_free,
    ...
    SubjectAltName_desc_tags_1,
    sizeof(SubjectAltName_desc_tags_1)
    / sizeof(SubjectAltName_desc_tags_1[0]), /* 1 */
    SubjectAltName_desc_tags_1,    /* Same as above */
    sizeof(SubjectAltName_desc_tags_1)
    / sizeof(SubjectAltName_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_SubjectAltName_desc(void)
{
