...
#undef FILE_MARKER
#define FILE_MARKER "pkix/struct/OrganizationName.c"
...
static const ber_tlv_tag_t OrganizationName_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (19 << 2))
};
asn_TYPE_descriptor_t OrganizationName_desc = {
    "OrganizationName",
    "OrganizationName",
    ...
    OrganizationName_desc_tags_1,
    sizeof(OrganizationName_desc_tags_1)
    / sizeof(OrganizationName_desc_tags_1[0]), /* 1 */
    OrganizationName_desc_tags_1,    /* Same as above */
    sizeof(OrganizationName_desc_tags_1)
    / sizeof(OrganizationName_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_OrganizationName_desc(void)
{
    return &OrganizationName_desc;
}
