...
#undef FILE_MARKER
#define FILE_MARKER "pkix/struct/PolicyQualifierId.c"
...
static const ber_tlv_tag_t PolicyQualifierId_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (6 << 2))
};
asn_TYPE_descriptor_t PolicyQualifierId_desc = {
    "PolicyQualifierId",
    "PolicyQualifierId",
    ...
    PolicyQualifierId_desc_tags_1,
    sizeof(PolicyQualifierId_desc_tags_1)
    / sizeof(PolicyQualifierId_desc_tags_1[0]), /* 1 */
    PolicyQualifierId_desc_tags_1,    /* Same as above */
    sizeof(PolicyQualifierId_desc_tags_1)
    / sizeof(PolicyQualifierId_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_PolicyQualifierId_desc(void)
{
    return &PolicyQualifierId_desc;
}
