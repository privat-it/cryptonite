...
asn_enc_rval_t
UnprotectedAttributes_encode_der(asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
UnprotectedAttributes_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static const ber_tlv_tag_t UnprotectedAttributes_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (17 << 2))
};
asn_TYPE_descriptor_t UnprotectedAttributes_desc = {
    "UnprotectedAttributes",
    "UnprotectedAttributes",
    UnprotectedAttributes_free,
    UnprotectedAttributes_print,
    UnprotectedAttributes_constraint,
    UnprotectedAttributes_decode_ber,
    UnprotectedAttributes_encode_der,
    UnprotectedAttributes_decode_xer,
    UnprotectedAttributes_encode_xer,
    0, 0,    /* No PER support, use "-gen-PER" to enable */
    0,    /* Use generic outmost tag fetcher */
    UnprotectedAttributes_desc_tags_1,
    sizeof(UnprotectedAttributes_desc_tags_1)
    / sizeof(UnprotectedAttributes_desc_tags_1[0]), /* 1 */
    UnprotectedAttributes_desc_tags_1,    /* Same as above */
    sizeof(UnprotectedAttributes_desc_tags_1)
    / sizeof(UnprotectedAttributes_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_UnprotectedAttributes_desc(void)
{
