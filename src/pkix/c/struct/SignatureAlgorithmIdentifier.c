...
#undef FILE_MARKER
#define FILE_MARKER "pkix/struct/SignatureAlgorithmIdentifier.c"
...
static const ber_tlv_tag_t SignatureAlgorithmIdentifier_desc_tags_1[] = {
    (ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_TYPE_descriptor_t SignatureAlgorithmIdentifier_desc = {
    ...
    SignatureAlgorithmIdentifier_desc_tags_1,
    sizeof(SignatureAlgorithmIdentifier_desc_tags_1)
    / sizeof(SignatureAlgorithmIdentifier_desc_tags_1[0]), /* 1 */
    SignatureAlgorithmIdentifier_desc_tags_1,    /* Same as above */
    sizeof(SignatureAlgorithmIdentifier_desc_tags_1)
    / sizeof(SignatureAlgorithmIdentifier_desc_tags_1[0]), /* 1 */
...
asn_TYPE_descriptor_t *get_SignatureAlgorithmIdentifier_desc(void)
{
    return &SignatureAlgorithmIdentifier_desc;
}
